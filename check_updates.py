...
(packages no longer maintained on AUR) are removed and the change is committed back to
the repository.

Usage:
    python check_updates.py detect [--dry-run] [--maintainer cbrnr]
...
def cmd_finalize(args: argparse.Namespace) -> None:
    ...
    pkg_config = config.get(args.pkgname)
